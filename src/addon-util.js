...
util.createComicViewer = async (
  ...
  infoBox.style.width = window.innerWidth * 0.2 + "px"
  infoBox.style.flexDirection = "column"
  const createBtn = (name) => {
    const btn = document.createElement("button")
    btn.innerHTML = name
    btn.style.backgroundColor = "#ED2553"
